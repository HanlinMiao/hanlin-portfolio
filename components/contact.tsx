  ...
  return (
    ...
    >
        ...
        <p className="text-gray-700 -mt-5">
            Please contact me directly at <a className="underline" href="mailto:hanlin980505@gmail.com">hanlin980505@gmail.com</a>{" "}
        ...
        <form className="mt-10 flex flex-col" action={
            ...
            <textarea className="h-52 p-4 my-3 rounded-lg borderBlack" name="message" placeholder="Your message" required maxLength={5000}/>
            <SubmitBtn />
        </form>
    </motion.section>
  )
